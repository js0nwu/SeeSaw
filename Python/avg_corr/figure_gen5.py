...
pplot.savefig(TARGET_DIR + folderName + "_correlation_time_avg_vs_noise" + str(SKIP_CYCLES).replace(".", "_") + "_" + ("saw" if FIT_SAW else "sine") + FILE_FORMAT)