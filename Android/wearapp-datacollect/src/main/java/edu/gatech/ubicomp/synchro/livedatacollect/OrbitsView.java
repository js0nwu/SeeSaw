...
//		RectF mOvalRight = new RectF(screenW/2, screenH/4, screenW, screenH*3/4); //This is the area you want to draw on
		...
		RectF mOvalLeft = new RectF(0, (screenH/2)-48, 0+(48*2), (screenH/2)+48); //This is the area you want to draw on
		RectF mOvalRight = new RectF((screenW)-(48*2), (screenH/2)-48, (screenW), (screenH/2)+48); //This is the area you want to draw on
