    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonController.addTimer(new Runnable() {
            ...
            public void run() {
                ...
                meanTapDetector.detect(new Tuple2<>(new NVector(leftMagVal), new NVector(rightMagVal)));
                stdTapDetector.detect(new Tuple2<>(new NVector(leftMagVal), new NVector(rightMagVal)));
				if(recordingMode) {
