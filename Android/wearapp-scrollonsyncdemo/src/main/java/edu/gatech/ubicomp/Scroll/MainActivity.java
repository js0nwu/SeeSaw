...
public class MainActivity extends Activity implements SensorEventListener {
    ...
    private edu.gatech.ubicomp.scroll.Controller buttonController = new edu.gatech.ubicomp.scroll.Controller("ButtonController");
            ...
            public void onEventRecognized(String result) {
                ...
                if(inSync && orbitsView.getSyncDirection().equals("right"))
                {
                    scrollView.post(new Runnable() {
                        public void run() {
                            scrollView.smoothScrollBy(20,20);
                        }
                    });
                }
                else
